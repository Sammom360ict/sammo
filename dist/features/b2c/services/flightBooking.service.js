            ...
            return yield this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                const traveler_promises = body.passengers.map((element) => __awaiter(this, void 0, void 0, function* () {
                    if (element.save_information) {
                        ...
                        return travelersModel.insertTraveler(Object.assign({ user_id, first_name: mid_name, title: reference, mobile_number: phone, country_id: country ? Number(country) : undefined, passport_expiry_date: passport_expire_date ? passport_expire_date.split("T")[0] : undefined }, rest));
                    }
                }));
