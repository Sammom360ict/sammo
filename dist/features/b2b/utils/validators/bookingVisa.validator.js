...
class VisaValidator {
    constructor() {
        ...
        this.traveler_types = ['ADT', 'INF', 'C02', 'C03', 'C04', 'C05', 'C06', 'C07', 'C08', 'C09', 'C10', 'C11'];
        ...
        this.travelerSchema = joi_1.default.object({
            type: joi_1.default.string().valid(...this.traveler_types).required(),
            title: joi_1.default.string().valid(...this.traveler_titles).required(),
