...
class PaymentController extends abstract_controller_1.default {
    constructor() {
        ...
        this.insertAgencyCredit = this.asyncWrapper.wrap({ bodySchema: this.commonValidator.createAirportSchema }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _a = yield this.services.insertAgencyCredit(req), { code } = _a, data = __rest(_a, ["code"]);
