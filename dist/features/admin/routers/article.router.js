...
class AdminArticleRouter extends abstract_router_1.default {
    ...
    callRouter() {
        ...
        this.router
            .route('/')
            .post(this.uploader.cloudUploadRaw(this.fileFolders.ADMIN_FILES), this.AdminArticleController.createArticle)
        ...
        this.router
            ...
            .patch(this.uploader.cloudUploadRaw(this.fileFolders.ADMIN_FILES), this.AdminArticleController.updateArticle)
