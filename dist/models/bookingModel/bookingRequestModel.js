...
class BookingRequestModel extends schema_1.default {
    ...
    insert(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db('booking_request').withSchema(this.BOOKING_SCHEMA).insert(payload, 'id');
        });
    }
    // get booking request
    get(params_1) {
    ...
    insertSegment(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db('booking_request_segment').withSchema(this.BOOKING_SCHEMA).insert(payload);
        });
    }
    // get segment
    ...
    insertTraveler(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db('booking_request_traveler').withSchema(this.BOOKING_SCHEMA).insert(payload);
        });
    }
    // get traveler
