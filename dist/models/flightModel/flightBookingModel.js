...
class FlightBookingModel extends schema_1.default {
    ...
    getAllFlightBooking(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield this.db('booking.flight_booking as fb')
                .select('fb.id as booking_id', 'us.username as created_by', 'fb.pnr_code', 'fb.total_passenger', 'fb.ticket_issue_last_time', 'fb.status', 'fb.payable_amount', 'fb.discount', 'fb.ticket_price', 'fb.journey_type', 'fb.created_at')
            ...
            const total = yield this.db('booking.flight_booking as fb')
    ...
    getSingleFlightBooking(wherePayload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.db('booking.flight_booking as fb')
    ...
    getFlightTraveler(flight_booking_id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db("booking.flight_booking_traveler as fb")
                .select("fb.*")
                .where({ flight_booking_id });
        });
    }
