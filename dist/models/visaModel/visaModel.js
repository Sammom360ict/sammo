...
class VisaModel extends schema_1.default {
    ...
    getB2CApplication(query_1) {
        return __awaiter(this, arguments, void 0, function* (query, is_total = false) {
            var _a;
            const data = yield this.db('booking.visa_application as va')
                ...
                if (query.filter) {
                    qb.andWhere((qbc) => {
                        ...
                        qbc.orWhereRaw("LOWER(us.first_name || ' ' || us.last_name) LIKE LOWER(?)", [`%${query.filter ? query.filter.toLocaleLowerCase() : undefined}%`]);
                    });
                }
            ...
            let total = [];
            if (is_total) {
                total = yield this.db('booking.visa_application as va')
    ...
    b2cSingleApplication(id, user_id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db('booking.visa_application as va')
    ...
    b2cTravelerList(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db('booking.visa_application_traveller as vat')
