...
import { ICreateFlightBookingPayload, IInsertFlightSegmentPayload, IInsertFlightTravelerPayload } from '../../utils/interfaces/agent/b2bFlightBookingInterface';
    ...
    public async getAllFlightBooking(payload: {
        ...
        const data = await this.db('b2b.flight_booking as fb')
            .select(
                ...
                this.db.raw("CONCAT(fb.contact_country_dialing_code,fb.contact_phone_number) as contact_number"),
                'fb.contact_email',
                'fb.order_reference',
                'fb.pnr_code',
                'fb.total_passenger',
