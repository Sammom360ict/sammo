...
export class BookingRequestModel extends Schema {
    ...
    public async insert(payload: IInsertBookingRequestPayload) {
        return await this.db('booking_request').withSchema(this.BOOKING_SCHEMA).insert(payload, 'id');
    }
    ...
    public async insertSegment(payload: IInsertBookingRequestSegment[]) {
        return await this.db('booking_request_segment').withSchema(this.BOOKING_SCHEMA).insert(payload);
    }
    ...
    public async insertTraveler(payload: IInsertBookingRequestTravelerPayload[]) {
        return await this.db('booking_request_traveler').withSchema(this.BOOKING_SCHEMA).insert(payload);
    }
