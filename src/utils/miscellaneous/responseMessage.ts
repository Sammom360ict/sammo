class ResMsg {
  ...
  static readonly PERMISSION_EXISTS_FOR_ROLE = 'Selected permission already exists for this role';
  static readonly PERMISSION_NOT_FOUND_FOR_ROLE = 'Selected permission not found for this role';
  ...
  //article
  static readonly SLUG_EXISTS = 'Article with this title already exists';
}
