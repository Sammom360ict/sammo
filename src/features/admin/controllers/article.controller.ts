...
class AdminArticleController extends AbstractController {
    ...
    public createArticle = this.asyncWrapper.wrap(
        ...
        async (req: Request, res: Response) => {
            const { code, ...data } = await this.AdminArticleService.createArticle(req);
    ...
    public getArticleList = this.asyncWrapper.wrap(
        ...
        async (req: Request, res: Response) => {
            const { code, ...data } = await this.AdminArticleService.getArticleList(req);
            res.status(code).json(data);
        }
    );
    ...
    public getSingleArticle = this.asyncWrapper.wrap(
        ...
        async (req: Request, res: Response) => {
            const { code, ...data } = await this.AdminArticleService.getSingleArticle(req);
            res.status(code).json(data);
        }
    );
    ...
    public updateArticle = this.asyncWrapper.wrap(
        ...
        async (req: Request, res: Response) => {
            const { code, ...data } = await this.AdminArticleService.updateArticle(req);
            res.status(code).json(data);
        }
    );
    ...
    public deleteArticle = this.asyncWrapper.wrap(
        ...
        async (req: Request, res: Response) => {
            const { code, ...data } = await this.AdminArticleService.deleteArticle(req);
            res.status(code).json(data);
        }
    );
